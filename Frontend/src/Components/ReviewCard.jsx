...
function ReviewCard({ review }) {
  ...
  return (
    <div className="bg-black/90 text-white max-w-sm w-full rounded-2xl border border-white/10 p-5 hover:border-white/20 hover:shadow-lg transition duration-300 shadow-[#1D79D3] shadow-sm">

      {/* Header */}
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-base font-semibold">@{review.clientName}</h3>

        <span className="text-xs bg-neutral-900 border border-neutral-700 px-3 py-1 rounded-full text-gray-300">
          {review.service}
        </span>
      </div>
